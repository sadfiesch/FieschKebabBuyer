...
public class MoveToVendor extends TaskNode {
    @Override
    ...
    @Override
    public int execute() {
        log("Moving to vendorarea");
        if(!Util.vendorArea.contains(Players.localPlayer())) {
            Tile rndTile = Util.vendorArea.getRandomTile();
